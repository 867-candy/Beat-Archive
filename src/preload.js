...
contextBridge.exposeInMainWorld('api', {
  ...
  checkSongsExist: (sha256List, md5List) => ipcRenderer.invoke('check-songs-exist', sha256List, md5List),
  ...
  getSongMetadata: (hash) => ipcRenderer.invoke('get-song-metadata', hash),
